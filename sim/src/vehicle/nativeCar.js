...
export class NativeCar {
  ...
  pushParams() {
    ...
    rigNative.command({
      ...
      dtStaticCamberFrontDeg: p.dt?.staticCamberFrontDeg, dtStaticCamberRearDeg: p.dt?.staticCamberRearDeg,
      dtAckermann: p.dt?.ackermann,
      dtBumpSteerFrontDegPerIn: p.dt?.bumpSteerFrontDegPerIn, dtBumpSteerRearDegPerIn: p.dt?.bumpSteerRearDegPerIn,
