  ...
  return [
    ...
    rows("4-wheel β setup (model 3 only)", [
      ...
      p("Front grip scale", v.dt.frontGripScale, "", "calibrated",
        "Front lateral grip x the front grip factor. With the rear scale, pinned to the timed skidpad at the bicycle's own number (5.16 vs 5.14 s) while still pushing at 10/15/20 m/s.",
        { path: "dt.frontGripScale", min: 0.8, max: 1.4, step: 0.005 }),
      p("Rear grip scale", v.dt.rearGripScale, "", "calibrated",
        "Rear lateral grip relative to the tyre's mu. See the front scale.",
