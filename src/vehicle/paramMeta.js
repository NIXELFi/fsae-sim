...
export function parameterGroups() {
  ...
  return [
    rows("Mass & geometry", [
      ...
      p("Yaw inertia Izz", v.izzKgM2, "kg·m²", "estimate",
        "Not measured. FSAE cars on a bifilar rig land 85–130; 105 gives a dynamic index of 0.67, the mass-concentrated character of a small formula car. Measure this on a rig.", { path: "izzKgM2", min: 50, max: 220, step: 1 }),
      p("Unsprung mass, front corner", v.unsprungFrontKg, "kg", "estimate",
        "Upright, hub, brake, wheel, tyre and half the arms. Sets sprung mass and the unsprung share of lateral load transfer.",
        { path: "unsprungFrontKg", min: 4, max: 22, step: 0.1 }),
      p("Unsprung mass, rear corner", v.unsprungRearKg, "kg", "estimate",
        "As the front, plus the driveshaft and sprocket side of the corner.",
    ...
    rows("Tyres & grip", [
      ...
      p("Load sensitivity", v.tireLoadSensitivity, "—", "team",
        "Hoosier R20 slick: μ falls 15% when load doubles. From Helios' tyre characterisation."),
    ...
    rows("Powertrain", [
      ...
      p("Idle speed", v.idleRpm, "rpm", "estimate", "Added for this model; Helios has no idle."),
      ...
      p("Wheel inertia, front axle", v.wheelInertiaFrontKgM2, "kg·m²", "estimate", "Per wheel.", { path: "wheelInertiaFrontKgM2", min: 0.05, max: 0.7, step: 0.005 }),
      p("Wheel inertia, rear axle", v.wheelInertiaRearKgM2, "kg·m²", "estimate", "Per wheel, including sprocket and disc.", { path: "wheelInertiaRearKgM2", min: 0.05, max: 0.7, step: 0.005 }),
    ]),
